...
WebUI.click(findTestObject('Object Repository/Page_SECRET SALES  OH, HELLO BLACK FRIDAY  _0edd18/button_View  edit bag'))

WebUI.click(findTestObject('Object Repository/Page_Shopping Bag/button_Remove'))
